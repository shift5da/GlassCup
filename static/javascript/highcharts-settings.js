$(function() {
  ...
  Dashboard.Helpers.elementExists('.highcharts-1', function() {
    $(this).highcharts({
      chart: {
        type: 'column'
      },
  ...
  Dashboard.Helpers.elementExists('.highcharts-2', function() {
    $(this).highcharts({
      chart: {
        renderTo: 'container',
  ...
  Dashboard.Helpers.elementExists('.highcharts-3', function() {
    $(this).highcharts({
      chart: {
        renderTo: 'container',
        backgroundColor: 'transparent',
  ...
  Dashboard.Helpers.elementExists('.highcharts-4', function() {
    $(this).highcharts({
      title: {
        text: ''
      },
  ...
  Dashboard.Helpers.elementExists('.highcharts-5', function() {
    $(this).highcharts({
      chart: {
        type: 'column'
    },
